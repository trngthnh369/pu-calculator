      ...
      {show && (
        ...
        >
          <div className="container mx-auto px-[5%] py-[2.5vh]">
            <h3 className="text-sm text-gray-400 mb-[2vh] font-medium">Khuôn Thường Dùng</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-[2.5%]">
              {presets.map((preset) => (
                ...
                >
                  <div className="px-[6%] py-[2vh]">
                    <div className="font-mono text-sm text-cyan-400 mb-[1vh] font-semibold">
                      {preset.name}
                    </div>
